                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog_post box_shadow1 radius_all_10 animation" data-animation="fadeInUp"
                                ...
                                <div class="blog_img radius_ltrt_10">
                                    @if($newz->image)
                                    <a href="{{route('newsdetail',$newz->slug)}}">
                                        <img src="{{asset($newz->image)}}" alt="blog_small_img1">
                                        <div class="link_blog">
                                    ...
                                    @else
                                    <div class="blog_img radius_ltrt_10">
                                        <a href="{{route('newsdetail',$newz->slug)}}"><img src="{{asset('assets/images/download.png')}}"
                                                height="270px"
                                                alt="event_img1"/></a>
                                                <div class="link_blog">
                                                    <span class="ripple"><i class="fa fa-link"></i></span>
                                ...
                                <div class="blog_content bg-white">
                                    <h6 class="blog_title"><a href="{{route('newsdetail',$newz->slug)}}">{{$newz->title}}?</a></h6>
                                    <p>{{$newz->meta_description}}</p>
                                    <a href="{{route('newsdetail',$newz->slug)}}" class="text-capitalize">Read More</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
